...
//     final provider = Provider.of<ShelterMapProvider>(context, listen: false);
//
//     // API 호출을 진행 중인 상태인지 확인
//     if (!provider.isLoading) {
//       await provider.loadShelterMapService();
//     }
//   }
//
//   @override
//   Widget build(BuildContext context) {
//     return Consumer<ShelterMapProvider>(
...
//             ],
//           ),
//           body: provider.shelterMapService.isEmpty && provider.isLoading
//               ? Center(child: CircularProgressIndicator())
//               : provider.shelterMapService.isEmpty && !provider.isLoading
//               ? Center(child: Text('No disaster messages found'))
//               : ListView(
//             padding: EdgeInsets.zero,
//             children: [
//               ...provider.shelterMapService.map((message) {
//                 final index = provider.shelterMapService.indexOf(message);
...
//                   text: '[${message.rdnmadr_cd}] ${message.rn_adres}',
//                   registrationDate: message.acmdfclty_se_nm,
//                 );
//               }).toList(),
//             ],
//           ),
